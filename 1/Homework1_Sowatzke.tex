...
\begin{document}
	...
	\begin{enumerate}
		...
		\begin{equation*}
			N(h_1) = (a_{11}h_1 + \cdots a_{1N}h_N + a_{11}h_1 + \cdots a_{N1}h_N)
		\end{equation*}
		
		\begin{equation*}
			\cdot [h_1(b_{11}h_1 + \cdots + b_{1N}h_N) + \cdots + h_N( b_{N1}h_1 + \cdots + b_{NN}h_N)]
		\end{equation*}
		...
		\begin{equation*}
			\cdot (b_{11}h_1 + \cdots b_{1N}h_N + b_{11}h_1 + \cdots b_{N1}h_N)
		\end{equation*}\\
		
		\begin{equation*}
			\frac{\partial{J(\mathbf{h})}}{\partial{h_1}} = \frac{(a_{11}h_1 + \cdots a_{1N}h_N + a_{11}h_1 + \cdots a_{N1}h_N)[h_1(b_{11}h_1 + \cdots + b_{1N}h_N) + \cdots + h_N( b_{N1}h_1 + \cdots + b_{NN}h_N)]}{[h_1(b_{11}h_1 + \cdots + b_{1N}h_N) + \cdots + h_N( b_{N1}h_1 + \cdots + b_{NN}h_N)]^2}
		\end{equation*}
