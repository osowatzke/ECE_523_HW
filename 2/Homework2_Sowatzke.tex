...
\begin{document}
	...
	\begin{enumerate}
		...
		Using this classifier on the projected data, I was able to generate a confusion matrix and determine the classification accuracy. My code for this problem is included in Appendix \ref{fisher_ldf}. To visualize the classification, I generated a histogram of the projected data and the resulting decision boundaries. This histogram is included in Figure \ref{fisher_ldf_histogram}.
		...
		The confusion matrix and classification accuracy are also output by the program and are given in Figure \ref{fisher_ldf_stats} below.
